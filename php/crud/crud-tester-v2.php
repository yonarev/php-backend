<?php
    ...
    function crear_registro($nombre, $correo) {
        ...
        $consulta->execute();
        header("Location: crud-tester-v2.php");
        exit();
    }
...
<html lang="es">
    ...
    <body>
        ...
        <form method="post" action="crud-tester-v2.php">
        ...
        <table border="1">
            ...
            <?php foreach ($resultados as $fila): ?>
                <tr id="fila-<?php echo htmlspecialchars($fila['id']); ?>">
                    ...
                    <td>
                        <form action="crud-tester-v2.php" method="get" style="display:inline;">
