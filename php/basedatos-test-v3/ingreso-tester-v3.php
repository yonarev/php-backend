<?php
    // http://localhost:8080/dashboard/basedatos/ingreso-tester-v3.php
        ...
        try {
            ...
            if ($e->errorInfo[1] == 1062) {
                ...
                if (strpos($duplicado, 'nombre') !== false) {
                    header("Location: error-v3.php?mensaje=El nombre ya existe. Por favor, ingresa un nombre diferente.");
                } elseif (strpos($duplicado, 'correo') !== false) {
                    header("Location: error-v3.php?mensaje=El correo ya existe. Por favor, ingresa un correo diferente.");
                } else {
                    header("Location: error-v3.php?mensaje=Error de clave duplicada.");
                }
            } else {
                // Otro tipo de error
                header("Location: error-v3.php?mensaje=Error al insertar el registro.");
            }
            exit();
        }
    }
